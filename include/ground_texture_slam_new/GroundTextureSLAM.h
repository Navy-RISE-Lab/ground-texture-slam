...
class GroundTextureSLAM {
 public:
   ...
   *     options: ground_texture_slam_new.GroundTextureSLAM.Options,
   ...
   * @note Python syntax:
   * @code {.py}
   * ground_texture_slam_new.GroundTextureSLAM.get_pose_estimates_matrix() ->
   ...
   * @note Python syntax:
   * @code {.py}
   * ground_texture_slam_new.GroundTextureSLAM.insert_measurement(
